...
```objc
@interface UIViewController (MediaPlaying)
...
```objc
@interface Advertisement (private)
...
```objc
static NSString * const kAboutViewControllerCompanyName = @"Swift Gift Company";
...
```objc
#define CompanyName @"Swift Gift Company"
